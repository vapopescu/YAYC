$(document).ready(() => {
  ...
  function retrieve_videos(userData, search_for) {
    data = apiRequest("GET", null, 'video/' + "?load=user&query=" + search_for, userData.token); //retrieve data for videos
    if (data != null) {
  ...
  function setup() {
    ...
    search_for = getUrlQuery();
    console.log("Searching for: " + search_for);
    //console.log(userData);
    if (search_for && userData) {
      //setting title of the page
      $("#searching_title").text("The results for: " + search_for);
